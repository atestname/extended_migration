...
if flag == 1 %data is given in frequency domain
    ...
    F = opKron(Fs,Fr,It);
    U = F*vec(u);
    f = tf; % thif f would be 0 centered
...
ks = kr;
%%
%% kr and ks do not have same size as x ?????
%%
%% compute DSR
...
%%
%% DSR1 and 2 should have same sign!!
%%
